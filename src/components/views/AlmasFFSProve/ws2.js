    ...
    */
    ...
    genX(n, forID, rnd = 1) {
        let r = Math.floor(Math.random() * n),
            ...
            xJSON = JSON.stringify(jsonPayload(forID, rnd, 1, x));
        return [r, x, xJSON];
    }
    ...
    almasFFSSubmit = (data) => {
        ...
        */
        ...
        ws.onopen = () => {
            ...
            if(this.stepCheck < 0) {
                let inj = {'I': I, 'j' : j, 'n' : n},
                	innit = JSON.stringify(jsonPayload(forID, 1, 0, inj));
                this.stepCheck = 0
        ...
        ws.onmessage = (event) => {
            ...
            =================================== */
                ...
                console.log('y: ' + y)
                let yJSON = JSON.stringify(jsonPayload(forID, data['round'], 3, y));
            ...
            =================================== */
                ...
                if (rndStatus['round'] < rnds) {
                    let innit = JSON.stringify(jsonPayload(forID, rndStatus['round']+1, 0, ""));
                    this.sendCheck(innit, ws);
                    rndStatus['round'] +=1;
                } else {
                    console.log('The End');
